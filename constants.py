...
#dodaj da sistem nece prepoznati ako ne napisu sve tacno
EMAIL_MISSING_DATA ="""
Dear Sir/Madam,

Thank you for your submission to @pc_setup_ideas.
Unfortunatly I have to inform you that your e-mail wasn't written correctly.

Inside Subject box you have to write "Submission - @your_username" (without quotes).
You also have to attach only one image of your setup.
One image, and only image, no videos.

If you have followed all of these rules and still got this e-mail please do contact me over DM on @pc_setup_ideas :)

Best regards,

Bogdan Caleta Ivkovic

PS. Don't reply on this e-mail since it's automated and I probably won't see it.
"""
...
*``````````````````````````````````````````````````````*
*``@pc_setup_ideas`````````````````````````````````````*
*``Version:1.0``````````Bogdan`Caleta`Ivkovic`(c)`2019`*
********************************************************
recieved submissions: {submissions}
